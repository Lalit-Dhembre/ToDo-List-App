...
val Context.datastore :DataStore<Preferences> by preferencesDataStore(name = Constants.DATASTORE_PREF)
...
class DataSourceRepository @Inject constructor(
   @ApplicationContext private val context: Context
    ...
    private object PreferenceKeys{
        val sortKey = stringPreferencesKey(name = Constants.DATASTORE_KEY)
    }
